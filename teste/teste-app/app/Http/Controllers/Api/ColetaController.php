...
class ColetaController extends Controller
{
    ...
    {
        $data = Coleta::where('finalizada', '=', 0)->where('chave_motorista', '=', $request->chave_motorista)->orderBy('data')->first();
        $coletas = ['coleta' => $data];
        return response()->json($coletas);
    }
    ...
    public function coletaEmAbertoPorPlaca($placa)
    {
        ...
        $data = Coleta::where('finalizada', '=', 0)->where('chave_motorista', '=', $motorista->chave_motorista)->orderBy('data')->first();
    ...
    public function NovaColeta(NovaColeta $request)
    {
        $coleta = [
            'finalizada'            => 0,
            'chave_motorista'       => $request->chave_motorista,
            'data'                  => $request->data,
