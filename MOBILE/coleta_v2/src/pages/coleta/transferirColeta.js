...
const Transferir = ({ removerID, coleta, data, horaI, navigation, save_coleta, adicionar_horaF }) => {
      ...
      try {
        ...
        try {
          ...
          const responseColetaEmAberto = await api.post('api/coleta/coletaEmAbertoPorMotorista', {
            chave_motorista: reboque.data.CHAVE
          })
        ...
        erroResponse = {
          "errors": {
            "404": [
              "A placa não pertence a um reboque."
            ]
          },
            ...
            {loading ? (
              ...
              <View style={styles.ViewTotalFinalizar}>
                ...
                <View style={{ marginTop: 20 }}>
                  ...
                  />
                  {erroReboque && <Text style={{ color: 'red', alignSelf: 'center' }}>Placa inválida! Selecione uma placa de Reboque!</Text>}
                </View>
